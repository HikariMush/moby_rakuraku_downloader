...
- ダウンロード前に楽曲の著作権／ライセンス情報を確認し、個別または一括でトラック選択できるようにしました。
...
- 本ツールは著作権で保護された楽曲のダウンロードに対して特に注意を払う必要があります。
- 楽曲のダウンロードは、SoundCloud の利用規約および各国の著作権法を遵守し、権利者の許可がある場合にのみ行ってください。
- 本リポジトリの配布物およびビルド版も、利用者が法令・利用規約を遵守することを前提としています。
